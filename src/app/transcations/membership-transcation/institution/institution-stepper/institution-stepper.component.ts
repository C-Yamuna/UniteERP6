...
export class InstitutionStepperComponent implements OnInit {
  ...
  addOrUpdate(activeIndex:any, buttonName:any) {
    ...
    this.institutionBasicDetailsModel.institutionStatus = 2;
    ...
    this.institutionBasicDetailsModel.registrationDate = this.commonFunctionService.getUTCEpoch(new Date(this.institutionBasicDetailsModel.registrationDateVal));
