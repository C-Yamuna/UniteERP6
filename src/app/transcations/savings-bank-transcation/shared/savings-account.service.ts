...
export class SavingsAccountService {
  ...
  downloadPreviewPDf(id:any){
    ...
    let url = ERP_TRANSACTION_CONSTANTS.DEMANDDEPOSITS+ERP_TRANSACTION_CONSTANTS.SAVINGS_ACCOUNT+ERP_TRANSACTION_CONSTANTS.SAVINGS_ACCOUNT_PDF_DOWNLOAD+"/"+id + "/"+status;
