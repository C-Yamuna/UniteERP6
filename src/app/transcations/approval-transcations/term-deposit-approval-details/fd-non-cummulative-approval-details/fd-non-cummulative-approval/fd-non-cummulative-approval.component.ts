  ...
  fileUploader(event: any, fileUpload: FileUpload) {
    ...
    for (let file of event.files) {
      ...
      reader.onloadend = (e) => {
        ...
        this.fdNonCumulativeApplicationModel.filesDTOList[this.fdNonCumulativeApplicationModel.filesDTOList.length - 1].fileName = "FD_Signed_Copy" + "_" + timeStamp + "_" + file.name;
        this.fdNonCumulativeApplicationModel.signedCopyPath = "FD_Signed_Copy" + "_" + timeStamp + "_" + file.name;
      }
